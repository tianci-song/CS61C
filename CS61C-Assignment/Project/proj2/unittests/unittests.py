...
class TestArgmax(TestCase):
    def test_simple(self):
        ...
        # create an array in the data section
        array0 = t.array([1, -1, 0, 3, 2, 1, 3, 0, -2])
...
class TestClassify(TestCase):
    ...
    def test_simple0_input0(self):
        t = self.make_test()
        out_file = "outputs/test_classify/simple0/bin/student0.bin"
        ref_file = "outputs/test_classify/simple0/bin/reference0.bin"
    ...
    def test_simple0_input1(self):
        t = self.make_test()
        out_file = "outputs/test_classify/simple0/bin/student1.bin"
        ref_file = "outputs/test_classify/simple0/bin/reference1.bin"
        args = ["inputs/simple0/bin/m0.bin", "inputs/simple0/bin/m1.bin",
    ...
    def test_simple0_input2(self):
        t = self.make_test()
        out_file = "outputs/test_classify/simple0/bin/student2.bin"
        ref_file = "outputs/test_classify/simple0/bin/reference2.bin"
        args = ["inputs/simple0/bin/m0.bin", "inputs/simple0/bin/m1.bin",
    ...
    def test_simple1_input0(self):
        t = self.make_test()
        out_file = "outputs/test_classify/simple1/bin/student0.bin"
        ref_file = "outputs/test_classify/simple1/bin/reference0.bin"
    ...
    def test_simple1_input1(self):
        t = self.make_test()
        out_file = "outputs/test_classify/simple1/bin/student1.bin"
        ref_file = "outputs/test_classify/simple1/bin/reference1.bin"
        args = ["inputs/simple1/bin/m0.bin", "inputs/simple1/bin/m1.bin",
    ...
    def test_simple1_input2(self):
        t = self.make_test()
        out_file = "outputs/test_classify/simple1/bin/student2.bin"
        ref_file = "outputs/test_classify/simple1/bin/reference2.bin"
        args = ["inputs/simple1/bin/m0.bin", "inputs/simple1/bin/m1.bin",
    ...
    def test_simple2_input0(self):
        t = self.make_test()
        out_file = "outputs/test_classify/simple2/bin/student0.bin"
        ref_file = "outputs/test_classify/simple2/bin/reference0.bin"
    ...
    def test_simple2_input1(self):
        t = self.make_test()
        out_file = "outputs/test_classify/simple2/bin/student1.bin"
        ref_file = "outputs/test_classify/simple2/bin/reference1.bin"
        args = ["inputs/simple2/bin/m0.bin", "inputs/simple2/bin/m1.bin",
    ...
    def test_simple2_input2(self):
        t = self.make_test()
        out_file = "outputs/test_classify/simple2/bin/student2.bin"
        ref_file = "outputs/test_classify/simple2/bin/reference2.bin"
        args = ["inputs/simple2/bin/m0.bin", "inputs/simple2/bin/m1.bin",
